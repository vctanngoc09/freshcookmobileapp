        ...
        viewModelScope.launch {
            try {
                ...
                val filteredList = list.filter { recipe ->
                    ...
                    val tokens = listOf(recipe.name) + recipe.ingredients
                    ...
                    val matchesDifficulty = difficultyMatches(recipe.difficulty ?: "", difficulty)

                    val recipeTime = recipe.timeCook.toFloat()
